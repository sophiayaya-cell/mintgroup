...
export const LABELS: Record<Locale, {
  ...
  vi: {
    ...
    inquiry: 'Liên hệ ngay',
    ourTeam: 'Đội ngũ của chúng tôi',
    teamIntro: 'Chúng tôi là đội ngũ chuyên nghiên cứu, phát triển và sản xuất các sản phẩm vệ sinh, bảo vệ sức khỏe và sự bình an của mỗi người dùng bằng hệ thống kiểm soát chất lượng nghiêm ngặt và đổi mới liên tục.',
  ...
  pt: {
    ...
    inquiry: 'Fale conosco',
    ourTeam: 'Nossa equipe',
    teamIntro: 'Somos uma equipe dedicada à P&D e fabricação de produtos de higiene, protegendo a saúde e a tranquilidade de cada usuário com rigoroso controle de qualidade e inovação contínua.',
